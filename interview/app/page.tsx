        ...
        <main className="flex flex-col justify-center h-[90%] static md:fixed w-screen overflow-hidden grid-rows-[1fr_repeat(3,auto)_1fr] z-[100] pt-[30px] pb-[320px] px-4 md:px-20 md:py-0">
          ...
          >
           ...
           <motion.h1
            ...
            className="relative md:ml-[-10px] md:mb-[37px] font-extrabold text-[16vw] md:text-[40px] font-inter text-[#1E2B3A] leading-[0.9] tracking-[-2px] z-[100]"
          >
            Human Intelligence - Conversational Architect
          ...
          <motion.h1
            ...
            className="relative md:ml-[-10px] md:mb-[37px] font-extrabold text-[16vw] md:text-[100px] font-inter text-[#1E2B3A] leading-[0.9] tracking-[-2px] z-[100]"
          >
            Expanding the light of <br />
            <span className="text-[#407BBF]">Human Consciousness</span>
          ...
          >
            <div className="w-1/2">
              ...
              Intelligence Building Through Dialogue
              </h2>
              <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal">
              Engage in dynamic, lifelike AI conversations that adapt to your responses, helping you construct and refine a personalized intelligence model based on deep, meaningful interactions.
              </p>
            </div>
            <div className="w-1/2">
              <h2 className="flex items-center font-semibold text-[1em] text-[#1a2b3b]">
              ...
              <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal">
              Unlock actionable insights through interactive AI interviews designed to capture and synthesize the nuances of human communication, empowering you to craft more authentic and effective conversational strategies.
              </p>
            </div>
          </motion.div>

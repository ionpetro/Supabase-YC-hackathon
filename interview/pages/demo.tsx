...
const questions = [
  {
    id: 1,
    name: "Lifepath Exploration Interview",
    description: "Capture the essence of your life journey, decision-making processes, and key experiences.",
    difficulty: "Quick and Passive",
  },
  {
    id: 2,
    name: "Cognitive Patterns Interview",
    description: "Map how you think, solves problems, and approaches challenges.",
    difficulty: "Deep and Reflective",
  },
];

const interviewers = [
  {
    id: "The Memory Keeper",
    name: "The Memory Keeper",
    description: "Dives into personal memories, asking about childhood, family traditions, key life moments, and defining experiences.",
    level: "L3",
  },
  {
    id: "The Confidant",
    name: "The Confidant",
    description: "Encourages users to share their inner thoughts, fears, aspirations, and secrets in a safe, judgment-free conversation.",
    level: "L5",
  },
  {
    id: "The Dreamer",
    name: "The Dreamer",
    description: "Explores hopes, dreams, and visions for the future to capture aspirational elements of someone’s personality.",
    level: "L7",
  },
];
...
export default function DemoPage() {
  ...
  const handleDownload = async () => {
    if (recordedChunks.length) {
      ...
      const question =
        selected.name === "The Memory Keeper"
          ? `What’s a childhood memory that still makes you smile?`
          : selectedInterviewer.name === "The Confidant"
          ? "What is your greatest fear, and how has it shaped you?"
          : selectedInterviewer.name === "The Daily Companion"
      ...
      if (upload.ok) {
        ...
        if (results.transcript.length > 0) {
          const prompt = `Please give feedback on the following question: ${question} given the following transcript: ${
            results.transcript
          }. ${
            selected.name === "Behavioral"
              ? "Please also evaluate how effectively the user conveyed the memory, focusing on emotional depth, sensory details, and context. Did their response illustrate why the memory makes them smile and how it connects to their personality or values? Provide feedback on how they could enhance their narrative, such as adding vivid descriptions, organizing their response, or deepening the emotional connection."
              : "Please also evaluate how effectively the user conveyed the memory, focusing on emotional depth, sensory details, and context. Did their response illustrate why the memory makes them smile and how it connects to their personality or values? Provide feedback on how they could enhance their narrative, such as adding vivid descriptions, organizing their response, or deepening the emotional connection."
              ...
              {recordingPermission ? (
                <div className="w-full flex flex-col max-w-[1080px] mx-auto justify-center">
                  ...
                  <span className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal mb-4">
                    Powered by world reknown & licensed psycholigists and therapists.
                  </span>
                  <motion.div
                    initial={{ y: -20 }}
                    animate={{ y: 0 }}
                                ...
                                src={
                                  selectedInterviewer.name === "John"
                                    ? selected.name === "Behavioral"
                                      ...
                                      : "https://projectsrc.com/wp-content/uploads/2024/07/57dc2708-0c79-408f-9109-9fe47d1cf171_11789467.mp4"
                                    ...
                                    : selected.name === "Behavioral"
                                    ? "https://liftoff-public.s3.amazonaws.com/DemoInterviewMale.mp4"
                                    : "https://projectsrc.com/wp-content/uploads/2024/11/interview.mp4"
                                }
                                type="video/mp4"
                              />
                            </video>
              ...
              {step === 1 ? (
                ...
                >
                  ...
                  <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal my-4">
                    Choose the activity that you wish to perform to build the data you want.
                  ...
                  <div>
                    ...
                    >
                      {selected.name === "Behavioral"
                        ...
                        : selectedInterviewer.name === "John"
                        ? "Share an example of excellent customer service you have provided in the past"
                        : selectedInterviewer.name === "Richard"
                  ...
                  >
                    {selectedInterviewer.name === "John" ? (
                      <motion.img
                        ...
                        transition={{ duration: 0.5, ease: [0.23, 1, 0.32, 1] }}
                        key="John"
                        src="/placeholders/interviewer.jpg"
